...
@st.cache_data
#  Creates a summary by extracting sentences that collectively represent the most important or relevant information within the original content.
...
def generate_abstractive_summary(call_contents):
    ...
    client = TextAnalyticsClient(language_endpoint, AzureKeyCredential(language_key))
    # Call the begin_analyze_actions method on your client, passing in the joined
    # call_contents as an array and an AbstractiveSummaryAction with a sentence_count of 2.
    poller = client.begin_analyze_actions(
        [joined_call_contents],
        actions = [
    ...
    for result in poller.result():
        ...
        abstractive_summary = " ".join([sentence.text for sentence in summary_result.summaries])
...
def generate_query_based_summary(call_contents):
    ...
    system = """   
        ...
        Write a five-word summary of the call transcript. and label it as 'call-title'.
        Write a two-sentence summary of the call transcript. and label it as 'call-summary'.
