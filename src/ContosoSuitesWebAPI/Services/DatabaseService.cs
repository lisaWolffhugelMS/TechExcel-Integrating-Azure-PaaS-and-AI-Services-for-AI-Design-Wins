...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
        [Description("Get all bookings from a single hotel.")]
    ...
    /// </summary>
    [KernelFunction]
        [Description("Get all bookings from a single hotel after a specific date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")]int hotelId, [Description("The starting date after which a booking need to be retrieved")]DateTime dt)
    {
